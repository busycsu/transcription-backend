...
exports.createCanonicalRequest = function(method, pathname, query, headers, payload) {
  console.log("querystring: "+exports.createCanonicalQueryString(query))
  return [
    method.toUpperCase(),
    pathname,
...
exports.createPresignedURL = function(method, host, path, service, payload, options) {
  ...
  // query['specialty']='PRIMARYCARE'
  // query['type']='CONVERSATION'
  console.log("return: "+options.protocol + '://' + host + path + '?' + querystring.stringify(query))
