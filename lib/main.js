...
$('#explain-button').click(
    ...
    function() {
        console.log("start explain")
        // $.ajax({
        //     type: "get",
        //     url: "https://medlineplus.gov/download/genetics/condition/alzheimer-disease.xml",
        ...
        // var options = {
        //     hostname: 'wsearch.nlm.nih.gov',
        //     path: '/ws/query?db=healthTopics&term=%22diabetes+medicines%22+OR+%22diabetes+drugs%22',
                    
        //     headers: { 
        //             'Host': 'wsearch.nlm.nih.gov',
        //             'Path': '/ws/query?db=healthTopics&term=%22diabetes+medicines%22+OR+%22diabetes+drugs%22',
        //             'Origin': 'https://wsearch.nlm.nih.gov/ws/query'
        //     }
        // };
        ...
        // request.open('GET', 'https://wsearch.nlm.nih.gov/ws/query?db=healthTopics&term=%22diabetes+medicines%22+OR+%22diabetes+drugs%22', true)
        ...
        // xml.open("GET", "https://wsearch.nlm.nih.gov/ws/query?db=healthTopics&term=%22diabetes+medicines%22+OR+%22diabetes+drugs%22", true);
        // console.log("after get",xml)
...
$('#comprehend-button').click(function (){
    transcription = $('#transcript').val();
    // transcription = 'The liver attachments to the adrenal kidney or divided than the liver was reflected superior early.'
    $('#comprehend-transcript').text(transcription);
